...
```
[GPT Image - repaint frame untuk YONARI (video VRM 3D -> karakter anime 2D)]
Input: (1) frame dari klip denise_01 (repaint_src_*.png di input/denise_01/repaint/), (2) sheet Yonari (simpan ke input/yonari_01/yonari_sheet.png)
Simpan hasil: E:\AI\ComfyUI\input\denise_01\repaint\yonari_repaint_5p8s.png (resolusi bebas; makin tinggi makin bagus)
(opsional kandidat kedua: repaint_src_11p5s_1080.png -> simpan yonari_repaint_11p5s.png)
```
...
- Outfit Yonari serba hitam = palet cocok dengan karakter sumber (merah-hitam) -> leak kemungkinan kecil.
...
- Outfit Yonari serba hitam = palet cocok dengan karakter sumber (merah-hitam) - leak kemungkinan kecil.
- Sheet Yonari perlu disimpan dulu ke `input/yonari_01/yonari_sheet.png`.
...
| Resolution | 0.6 MP |
| Sigma | `euler` + 8 titik CustomSigmas (7 update) |
...
- Workflow: `eikei-plan/custom/workflows/mv_15s/ongoing/h3_r2v_viggle_yonari_01_chunked_euler4.json`
